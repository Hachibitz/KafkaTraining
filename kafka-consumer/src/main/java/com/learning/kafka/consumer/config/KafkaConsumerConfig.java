package com.learning.kafka.consumer.config;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    ConsumerFactory<String, CarDTO> carConsumerFactory() {
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, CarDTO> carKafkaListenerContainerFactory() {
